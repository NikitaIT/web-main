...
We would love for you to contribute to Lead and help make it even better than it
is today! As a contributor, here are the guidelines we would like you to follow:
...
Help us keep Lead open and inclusive. Please read and follow our [Code of Conduct][coc]. -->

## <a name="question"></a> Got a Question or Problem?

**Do not open issues for general support questions as we want to keep GitHub issues for bug reports and feature requests.** You've got much better chances of getting your question answered on [Stack Overflow][stackoverflow] where the questions should be tagged with tag `lead`.
...
1. Run the full Lead test suite (see [common scripts](#common-scripts)),
...
1. In GitHub, send a pull request to `lead:master`.

- If we suggest changes then:

  - Make the required updates.
  - Re-run the Lead test suites to ensure tests are still passing.
...
we use the git commit messages to **generate the Lead change log**.
...
If your change affect more than one package, separate the scopes with a comma (e.g. `logger,config`).
...
[github]: https://github.com/NikitaIT/lead
[stackoverflow]: https://stackoverflow.com/questions/tagged/lead
[js-style-guide]: https://google.github.io/styleguide/jsguide.html
[new_issue]: https://github.com/NikitaIT/lead/issues/new
[gh_prs]: https://github.com/NikitaIT/lead/pulls
[commits_samples]: https://github.com/NikitaIT/lead/commits/master
